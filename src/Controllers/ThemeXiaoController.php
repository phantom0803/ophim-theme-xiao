...
namespace Ophim\ThemeXiao\Controllers;
...
class ThemeXiaoController
{
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::themexiao.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::themexiao.index', [
    ...
    public function getMovieOverview(Request $request, $movie)
    {
        ...
        return view('themes::themexiao.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request, $movie, $slug, $id)
    {
        ...
        return view('themes::themexiao.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
